...
Note: This is shamelessly copied from [here](https://github.com/cordon-thiago/airflow-spark)
...
* `spark-livy`: Apache Livy 
  * Image: bitnami/spark-livy:3.1.2
  * Port 8998
  * References:
    * https://github.com/dsynkov/spark-livy-on-airflow-workspace
...
Change to directory `docker-big-data-playground/docker/bitnami-livy` and run
Note : Livy doesn;t support Spark 3+ out of the box. Refer [here](https://stackoverflow.com/questions/67085984/how-to-rebuild-apache-livy-with-scala-2-12)
...
If you change the name or the tag of the docker image when building, remember to update the name/tag in 
docker-compose file.
...
Note: when running the docker-compose for the first time, the images 
`postgres:9.6`, `bitnami/spark:3.1.2` and `jupyter/pyspark-notebook:spark-3.1.2` 
